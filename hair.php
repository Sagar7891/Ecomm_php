...
<section class="category">
   ...
   <a href="category.php?category=shampoo" class="swiper-slide slide">
   ...
   <a href="category.php?category=serum" class="swiper-slide slide">
      ...
      <h3>Hair Regrowth Serum</h3>
   </a>

   <a href="category.php?category=pack" class="swiper-slide slide" id="mii">

      <h3>Hair Pack</h3>
   </a>

   <a href="category.php?category=mask" class="swiper-slide slide">

      <h3>Hair Mask</h3>
   </a>

   <a href="category.php?category=comb" class="swiper-slide slide">

      <h3>Neem Wodden Comb</h3>
   </a>

   <a href="category.php?category=pack" class="swiper-slide slide">

      <h3>Hair Natural Herbs pack</h3>
   </a>
