...
<section class="category">
   ...
   <a href="category.php?category=lotion" class="swiper-slide slide">
      
      <h3>Body Lotion</h3>
   </a>
  

   <a href="category.php?category=bar" class="swiper-slide slide">
      
      <h3>Cold Processed Soap</h3>
   </a>
   ...
   <a href="category.php?category=bodybutter" class="swiper-slide slide" id="mii">
    
      <h3>Body Butter</h3>
   </a>

   <a href="category.php?category=yogurt" class="swiper-slide slide">
     
      <h3>Body Yogurt</h3>
   </a>

   <a href="category.php?category=scrub" class="swiper-slide slide">
   
      <h3>Body Scrub</h3>
   </a>

   <a href="category.php?category=soaps" class="swiper-slide slide">
     
      <h3>Cold Processed Soaps</h3>
   </a>
