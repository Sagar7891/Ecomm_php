...
$features = filter_var($features, FILTER_SANITIZE_STRING);
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, details, price, category, image_01, image_02, image_03, image_04, image_05, features) VALUES(?,?,?,?,?,?,?,?,?,?)");
      $insert_products->execute([$product_name, $details, $price, $category, $image_01, $image_02, $image_03, $image_04, $image_05, $features]);


      if($insert_products){
         if($image_size_01 > 2000000000000000 OR $image_size_02 > 2000000000000000000 OR $image_size_03 > 2000000000000000000000){
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="inputBox">
         ...
         <div class="inputBox">
   <span>Product Features (optional)</span>
   <textarea name="features" placeholder="enter product features" class="box" maxlength="500000" cols="30" rows="10"></textarea>
</div>
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <textarea name="details" placeholder="enter product details" class="box" required maxlength="500000" cols="3000" rows="1000"></textarea>
         </div>
      </div>
